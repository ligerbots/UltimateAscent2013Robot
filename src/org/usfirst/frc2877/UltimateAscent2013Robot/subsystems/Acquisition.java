...
public class Acquisition extends Subsystem {
    ...
    public static AnalogChannel infraRedSensor1 = new AnalogChannel(1);
    public static AnalogChannel infraRedSensor2 = new AnalogChannel(2);
    public static AnalogChannel infraRedSensor3 = new AnalogChannel(3);
    public static AnalogChannel infraRedSensor4 = new AnalogChannel(4);
