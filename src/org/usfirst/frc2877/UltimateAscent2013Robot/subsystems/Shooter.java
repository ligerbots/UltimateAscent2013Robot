...
public class Shooter extends Subsystem {
    // These allow us to easily convert from degrees to radians and back
    private final double DEG2RAD = 0.01745329;
    private final double RAD2DEG = 1.0/DEG2RAD;
    ...
    CANJaguar shooterAngle = RobotMap.shooterShooterAngleControl;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public static final double ANGLESPEEDCONSTANT = .5;
    AnalogChannel shooterAngleSensor = RobotMap.shooterShooterAngleSensor;
    ...
    // This is the minimum angle of the shooter.  It must be in radians.
    private final double MIN_ANGLE = 20 * DEG2RAD;
    
    private final double MAX_VOLTAGE = 3.7;
    private final double MAX_ANGLE = 50  * DEG2RAD;
    ...
    public double shooterAngle() {
        double shooterAngleVoltage = shooterAngleSensor.getVoltage();
        return MIN_ANGLE + ((shooterAngleVoltage - MIN_VOLTAGE) / VOLTAGE_RANGE) * ANGLE_RANGE;
    }
}
