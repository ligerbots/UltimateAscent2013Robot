...
public class OI {
    ...
    public JoystickButton crap1;
    public JoystickButton crap2;
    
    public AcquisitionScrewControl screwDownOne = new AcquisitionScrewControl(-1);
    public AcquisitionScrewControl screwupOne = new AcquisitionScrewControl(1);
