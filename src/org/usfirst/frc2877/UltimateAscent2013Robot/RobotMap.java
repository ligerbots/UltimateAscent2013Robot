...
public class RobotMap {
    ...
    public static void init() {
        ...
        try
        {
            ...
            debugOut("Left Front Jaguar Control Mode", driveTrainJaguarLeftFront.getControlMode().toString());
            debugOutNumber("outputCurrent", driveTrainJaguarLeftFront.getOutputCurrent());
...
//        shooterShooterAngleEncoder.start();
        acquisitionAcquisitionRoller = new Relay(1, 5);
