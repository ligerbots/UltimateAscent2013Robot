...
public class Robot extends IterativeRobot {
    ...
    public boolean slotFull1;
    public boolean slotFull2;
    public boolean slotFull3;
    public boolean slotFull4;
    ...
    public void teleopPeriodic() {
         voltage1 = Robot.acquisition.infraRedSensor1.getVoltage();
         voltage2 = Robot.acquisition.infraRedSensor2.getVoltage();
         voltage3 = Robot.acquisition.infraRedSensor3.getVoltage();
         voltage4 = Robot.acquisition.infraRedSensor4.getVoltage();
        if (voltage1 > 2) {
            slotFull1 = true;
        } else {
            slotFull1 = false;
